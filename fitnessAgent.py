...
def main():
    ...
    st.markdown("""
        ...
        <h3 style='color: #00796b;'>Get personalized dietary and fitness plans tailored to your goals and preferences.</h3>
        <p style='color: #004d40;'>Our AI-powered system considers your unique profile to create the perfect plan for you.</p>
        </div>
...
st.markdown("""
    ...
    <div class="footer">
        <p>Made with ❤️ by Sanskar | <a href="https://github.com/sanskar" target="_blank">GitHub</a></p>
    </div>
    """, unsafe_allow_html=True)
